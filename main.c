...
int main(int argc, char *argv[])
{
    ...
    EstadoJuego estado_anterior = ESTADO_MENU; // Variable para estados
    ...
    while (corriendo)
    {
        ...
        while (SDL_PollEvent(&e))
        {
            ...
            case ESTADO_CARGAR:
                ...
                manejar_eventos_slots(&e, &estado_actual, &sonidos, &seleccion_cargar, menu_count, &juego);
            ...
            case ESTADO_PAUSA:
                ...
                break;
            case ESTADO_GUARDAR:
                manejar_eventos_slots(&e, &estado_actual, &sonidos, &seleccion_guardar, menu_count, &juego);
        ...
        if (juego.senialRender)
        {
            ...
            case ESTADO_GANADO:
                ...
                break;
            case ESTADO_CARGAR:
                dibujar_menu(&graficos, cargar_items, cargar_count, &seleccion_cargar);
                break;
            case ESTADO_PAUSA:
                interfazPausa(sistemas.renderer, sistemas.ventana, sistemas.font, &juego, &picords, juego.dificultad.dimension, &rbutton, &seleccion_pausa, Mix_PlayingMusic(), pausa_items, menu_count);
                break;
            case ESTADO_GUARDAR:
                interfazPausa(sistemas.renderer, sistemas.ventana, sistemas.font, &juego, &picords, juego.dificultad.dimension, &rbutton, &seleccion_guardar, Mix_PlayingMusic(), cargar_items, menu_count);
            default:
                break;
            }
        }
